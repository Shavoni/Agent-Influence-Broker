...
async def create_webhook(
    webhook_data: WebhookCreateRequest, current_user=Depends(get_current_user_token)
):
    """Create new webhook endpoint."""
    return await webhook_engine.create_webhook(webhook_data, current_user.user_id)
